...
from src.api.weather.context_types import (
    GraphqlContext,
    DependencyOverrideProvider,
)
...
async def create_context(
    ...
    return GraphqlContext(mongo_extractor=mongo_extractor)
...
def create_graphql(
    ...
    return GraphQL(
        graphql_schema,
        context_value=make_context_creator(dependency_overrider),
    )


graphql_app: GraphQL = create_graphql()
